...
from timm.utils.spectral_monitor import WeightSpectralMonitor
...
# Research / instrumentation parameters
group = parser.add_argument_group('Research instrumentation')
group.add_argument('--spec-monitor', action='store_true', default=False,
                   help='Enable spectral monitor for selected linear layers.')
group.add_argument('--spec-every', type=int, default=100,
...
def main():
    ...
    if args.spec_monitor:
        ...
        try:
            args._spec_monitor = WeightSpectralMonitor(
                model,
                patterns=patterns,
                topk=args.spec_topk,
